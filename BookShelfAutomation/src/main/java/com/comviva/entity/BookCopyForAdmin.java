...
@Entity
@Table(name="bookcopy2")
@DynamicInsert(true)
@DynamicUpdate(true)
public class BookCopyForAdmin {
...
public BookCopyForAdmin() {
		
	}

	public BookCopyForAdmin(String sub_book_id, String item_condition, Book books_id, Member member_id, LocalDate issueDate) {
		super();
