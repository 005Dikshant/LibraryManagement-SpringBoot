...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid" >
    ...
    <li><a href = "homi">Home</a></li>
      <li><a href = "displaysearchbook" class="active">Search Book</a></li>
...
<div class = "alert alert-success">${requestScope.username}</div>
	...
	<div class = "form-row">
               <div class = "form-group col-md-6">
                 <h4> <label for = "inputBId">Book Title</label> </h4>
                  <input type = "text" name = "txttitle"  class =" form-control" 
                      placeholder = "Book Title"/>
               </div>
               
               <div class = "form-group col-md-6">
                 <h4> <label for = "inputMId">Book Author</label></h4>
                  <input type = "text" name = "txtauthor" class =" form-control" 
                      placeholder = "Book Id"/>
               </div>
               
               <div class = "form-group col-md-6">
                  <label for = "inputMId">Book Genre</label>
                  <input type = "text" name = "txtgenre" class =" form-control" 
                      placeholder = "Book Id"/>
               </div>
               
               <div class = "form-group col-md-6">
                  <label for = "inputMId">Book Publisher</label>
