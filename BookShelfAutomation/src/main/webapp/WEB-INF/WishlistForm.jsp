...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid" >
    ...
    <li><a href = "homi">Home</a></li>
	  ...
	  <li><a href = "displaywishlistform" class="active">Add Into Wish list</a></li>
...
<div class = "alert alert-success">${requestScope.username}</div>
	...
	<div class = "form-row">
		   ...
		   <div class = "form-group col-md-6" >
			<button type = "submit" class = "btn btn-primary" class="d-flex justify-content-center">WishList</button>
			</div>
	 </div>
	</form>
	</div>
